...
import com.fanwe.lib.select.view.FSelectViewManager;
...
public class LiveMainBottomNavigationView extends FrameLayout implements View.OnClickListener
{
    ...
    private FSelectViewManager<LiveTabMainMenuView> mSelectionManager = new FSelectViewManager<>();
    ...
    {
        mSelectionManager.setReSelectCallback(new FSelectManager.ReSelectCallback<LiveTabMainMenuView>()
        {
            @Override
        ...
        mSelectionManager.addSelectCallback(new FSelectViewManager.SelectCallback<LiveTabMainMenuView>()
        {
            @Override
